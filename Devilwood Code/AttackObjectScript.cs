...
public class AttackObjectScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        IEnumerator MoveRoot()
        {
            ...
            Instantiate(bossAttackRumbleEffect, new Vector3(transform.position.x + particleOffSet, transform.position.y, transform.position.z), new Quaternion(0f,particleRotation,0f,0f));
